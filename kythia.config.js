...
function loadKythiaConfig() {
    return {
        ...
        owner: {
            ...
            // can be multiple, seperate with comma (eg: LORD_RAJBHAI,kenoura_)
            names: 'LORD_RAJBHAI',
        },
        /**
        ...
        bot: {
            ...
            activity: 'WITHER BOT V2 by LORD_RAJBHAI',
        ...
        addons: {
            ...
            ai: {
                ...
                // ai persona prompt
                personaPrompt: `You are Kythia, a friendly and helpful Discord assistant. You are cheerful, polite, and always ready to assist users with their questions. Your creator is LORD_RAJBHAI.`,
                // owner interaction prompt
                ownerInteractionPrompt: `LORD_RAJBHAI (1158654757183959091) is your developer.`,
                // daily greeter
                dailyGreeter: false,
        ...
        settings: {
            ...
            supportServer: 'https://discord.gg/es6kwz26My',
            ...
            // Owner's website
            ownerWeb: 'https://LORD_RAJBHAI.me',
            // Kythia website
