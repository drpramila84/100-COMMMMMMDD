    ...
    async execute(interaction, container) {
        ...
        const buildHelpReply = async (currentState) => {
            ...
            if (!selectedCategory) {
                ...
                container.addMediaGalleryComponents(
                    new MediaGalleryBuilder().addItems([
                        new MediaGalleryItemBuilder().setURL('https://cdn.discordapp.com/attachments/1347548901544038433/1435991774597480489/standard_1.gif?ex=690dfb0e&is=690ca98e&hm=c1e9a6ac4cb74ff3359302a439586d6fddf28eb06fc7d68af712fc154348725f&')
                    ])
                );
                ...
                const dashboardUrl = kythiaConfig.addons.dashboard?.url || 'http://localhost:6379';
                const supportServerUrl = kythiaConfig.settings.supportServer || 'https://discord.gg/es6kwz26My';
            ...
            if (!selectedCategory) {
                ...
                container.addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('© LORD_RAJBHAI')
                );
            } else {
